    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        ...
        <el-tabs v-model="activeName" class="tab">
          ...
          <el-tab-pane label="访问量" name="second">
            <el-row :gutter="10">
              ...
              <el-col :span="8">
                <h3 style="margin-top: 0px">门店访问量排名</h3>
                <ul>
                  <li>
                    <span class="rindex">1</span>
                    <span>肯德基</span>
        ...
        <div class="right">
          ...
          <span style="cursor: pointer" @click="setYear">本年</span>
          <el-date-picker
            v-model="value1"
            type="daterange"
            range-separator="至"
...
// cnpm install dayjs -S  安装dayjs插件，获取特定格式时间戳
...
export default {
  ...
  watch: {
    activeName() {
      // 每当activeName值变化时，修改myChart的配置
      // echartjs执行太快，css的100%还没来得及反应，js就已经执行完了，所以把100%转成100px。所以用setTimeout()函数延迟echart的执行
      setTimeout(() => {
        this.showChart()
      }, 0)
    }
  ...
  methods: {
          ...
          series: [
            {
              ...
              type: 'bar',
              barWidth: '60%',
              data: [10, 52, 200, 334, 390, 330, 220, 10, 220, 325, 290, 123]
            }
          ]
        })
      } else {
          ...
          series: [
            {
              ...
              type: 'bar',
              barWidth: '60%',
              data: [120, 152, 300, 434, 390, 330, 220, 70, 320, 325, 390, 223],
              color: 'yellowgreen'
            }
          ]
        })
    ...
    // 设置本周
    setWeek() {
      const day1 = dayjs().startOf('week').format('YYYY-MM-DD')
      const day2 = dayjs().endOf('week').format('YYYY-MM-DD')
      this.value1 = [day1, day2]
    },
    // 设置本月
    setMonth() {
